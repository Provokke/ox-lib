...
const useStyles = createStyles((theme, params: { type: string }) => ({
  container: {
    width: 320,
    height: 'fit-content',
    ...
    '&::before': {
      ...
      fontSize: '10px',
      fontWeight: 'bold',
      color: params.type === 'warning' ? '#000000' : '#ffffff',
      background: params.type === 'error'
        ? 'linear-gradient(90deg, #c00000 0%, #ff4040 50%, #c00000 100%)'
        : params.type === 'success'
        ? 'linear-gradient(90deg, #006000 0%, #40c040 50%, #006000 100%)'
        : params.type === 'warning'
        ? 'linear-gradient(90deg, #c0c000 0%, #ffff40 50%, #c0c000 100%)'
        : 'linear-gradient(90deg, #0080c0 0%, #40a0ff 50%, #0080c0 100%)',
    },
    '& > *': {
      marginTop: '20px',
    },
...
const Notifications: React.FC = () => {
  ...
  useNuiEvent<NotificationProps>('notify', (data) => {
    ...
    const { classes } = useStyles({ type: data.type || 'info' });
